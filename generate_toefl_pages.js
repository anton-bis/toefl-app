      ...
      <div class="modal-card">
        ...
        <div class="modal-body">
          ...
          <div class="log-entry">
            ...
            <div class="log-date">2026-06-21</div>
            <div class="log-detail">新增 macOS 构建支持，双平台自动更新机制打通。<br>修复 CI 构建包缺失 TPO 题库页面（四大模块空白）与关注合作照片不显示。<br>修复 javascript-obfuscator ESM 导入在 Windows 路径下的兼容性问题。<br>Mac DMG 文件名规范化为 toefl-practice-system-{version}-mac.dmg。</div>
          </div>
          <div class="log-entry">
            <div class="log-version">V1.1.6</div>
            <div class="log-date">2026-06-20</div>
            <div class="log-detail">修复打包后测试报告按钮点击空白：file:// 协议拦截器未剥离 ?mode=report 查询参数，导致路径解析为带问号的文件名，fs.existsSync 永远返回 false。<br>修复 Writing 结果页计时器显示 7111:32（intro 页过早保存 start_time，结果页 fallback 读到了过期时间戳）。</div>
          </div>
          <div class="log-entry">
          ...
          <div class="log-entry">
            <div class="log-version">V1.1.4</div>
            <div class="log-date">2026-06-18</div>
            <div class="log-detail">补全 update:check / quit-and-install IPC handler。修复 checkForUpdatesAndNotify → checkForUpdates。自动更新全流程正式打通。</div>
          </div>
          <div class="log-entry">
