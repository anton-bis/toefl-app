...
\[ANSWER\]
Some colleagues wanted to find out where they can register for a conference\.
\[/ANSWER\]
...
\[ANSWER\]
Unfortunately, the tickets were no longer available online\.
\[/ANSWER\]
...
\[ANSWER\]
This coffee tastes better than all of the other brands I've tried\.
\[/ANSWER\]
...
\[ANSWER\]
The only library in town is temporarily closed for renovations\.
\[/ANSWER\]
...
\[ANSWER\]
My sister can suggest one that might interest you\.
\[/ANSWER\]
...
Identity: Your friend Emma has recently moved to a new city and is feeling a bit overwhelmed. She has reached out to you for advice on how to adjust to her new environment and make new friends. You have lived in several cities before, and you have experience with finding ways to settle into new places.
To: Emma
Subject: Tips for settling into a new city
Requirements:
- Describe how you adjusted to a new city.
- Give Emma suggestions on how she can make new friends.
- Offer different ways to help her if she needs more advice.
